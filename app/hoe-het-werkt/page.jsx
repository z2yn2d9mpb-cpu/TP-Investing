    ...
    <>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 32 }} className="nav-desktop">
            ...
            <Btn primary href="#stappen" style={{ padding: "10px 24px", fontSize: "0.85rem" }}>Start nu</Btn>
          </div>
      ...
      {mobileOpen && (
        <div style={{
          ...
          <Btn primary href="#stappen" onClick={() => setMobileOpen(false)} style={{ marginTop: 16 }}>Start nu</Btn>
        </div>
      )}
    </>
  )
